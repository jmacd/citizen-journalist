#!/usr/bin/env python3
"""Build the exact committed Workbench source archive consumed by watershop."""
...
def main() -> None:
    ...
    if dirty:
        raise ValueError(
            "Workbench deployment inputs contain uncommitted changes:\n" + dirty
        )
...
if __name__ == "__main__":
    try:
        ...
        print(f"package-workbench: {error}", file=sys.stderr)
